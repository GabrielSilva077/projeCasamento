...
//   // Chama o back-end para diminuir o estoque
...
//   })
//     .then((response) => response.text()) // Use .text() para verificar a resposta do servidor
//     .then((data) => {
//       if (data === "Compra realizada com sucesso!") {
//       } else {
//         alert(data); // Exibe qualquer mensagem de erro do servidor
//       }
//     })
//     .catch((error) => {
